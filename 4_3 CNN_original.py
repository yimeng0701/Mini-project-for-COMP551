# -*- coding: utf-8 -*-
"""
Created on Thu Mar 22 20:53:24 2018

@author: Ibtihel, Sunanda, Yimeng
"""

#original image+early stopping +image augmentation
...
train_data, valid_data= train_test_split(train_x, test_size=0.2,random_state=4)
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fnet4=nn.Sequential(
            nn.Linear(320*4*4,1000),      #fully connected layer, output:1000
            nn.BatchNorm2d(1000),
            nn.ReLU(),
        )
...
np.savetxt("drive1/Colab Notebooks/accs_CNN_original.csv",accs,fmt='%f',delimiter=',')
np.savetxt("drive1/Colab Notebooks/loss_CNN_original.csv",recordloss,fmt='%f',delimiter=',')
np.savetxt("drive1/Colab Notebooks/totalloss_CNN_original.csv",totalloss,fmt='%f',delimiter=',')
